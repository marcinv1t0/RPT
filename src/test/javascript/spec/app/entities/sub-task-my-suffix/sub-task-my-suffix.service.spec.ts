...
describe('Service Tests', () => {
    ...
    describe('SubTaskMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SubTaskMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/sub-tasks';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SubTaskMySuffix', () => {
